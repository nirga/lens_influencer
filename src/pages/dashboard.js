        ...
        <div className="col-span-3 bg-slate-50">
            <div className="pt-4">
                <div className="bg-white w-full rounded-lg p-4">
                    ...
                    <div className="text-md font-bold mb-1">GET STARTED ...</div>
                    <div className="text-md mb-2">Options</div>
                    <div className="flex flex-col">
                        <Link to="/create-profile" className="text-lg mr-4 text-blue-600">1. Create a Profile</Link>
                        <Link to="/stake-profile" className="text-lg mr-4 text-blue-600">2. Stake in a Profile</Link>
                        <Link to="/claim-profile" className="text-lg mr-4 text-blue-600">3. Claim a Profile</Link>
                    </div>
                </div>
            </div>
        </div>
